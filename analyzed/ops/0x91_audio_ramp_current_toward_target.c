// Opcode 0x91 — audio_ramp_current_toward_target (analyzed)
...
//
// Cluster context:
// - 0x91: ramp current toward target (this).
// - 0x92: submit/apply current (scaled by DAT_00352c30) to audio via FUN_0030bd20.
...
unsigned int opcode_0x91_audio_ramp_current_toward_target(void)
{
