// Opcode 0x36 — script_read_flag_or_work_memory (alias wrapper)
...
// Note: The same underlying function is used by opcode 0x38 (branch by DAT_00355cd8).
...
unsigned int opcode_0x36_script_read_flag_or_work_memory(void)
{
